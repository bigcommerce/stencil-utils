...
describe('tools.imageSrcset', () => {
    test('should return a srcset if a valid image and srcset sizes are passed (inherent width)', () => {
    ...
    test('should return a srcset if a valid image and srcset sizes are passed (pixel denstesty)', () => {
    ...
    test('should return a src if a valid image and srcset size is passed (inherent width)', () => {
    ...
    test('should return a src if a valid image and srcset size is passed (pixel denstesty)', () => {
    ...
    test('should return a srcset made of default sizes if no sizes are provided', () => {
    ...
    test('should throw an error if an invalid srcset string is provided', () => {
        expect(() => {
            tools.imageSrcset.getSrcset('https://cdn.example.com/path/to/{:size}/image.png?c=2',
                {
                    '100w': '100w',
                    '1000w': '1000',
                });
    ...
    test('should throw an error if a non-object is provided as the sizes argument [array]', () => {
        expect(() => {
            tools.imageSrcset.getSrcset('https://cdn.example.com/path/to/{:size}/image.png?c=2',
                ['100w', '200w']);
        }).toThrow(new Error('Invalid srcset descriptor or size'));
    ...
    test('should throw an error if a non-object is provided as the sizes argument [string]', () => {
        expect(() => {
            tools.imageSrcset.getSrcset('https://cdn.example.com/path/to/{:size}/image.png?c=2',
                '100w');
        }).toThrow(new Error('Invalid srcset descriptor or size'));
