...
describe('Countries', () => {
    test('should use getById and return a number', () => {
        Base.prototype.makeRequest = jest.fn((url, method, params, callback) => {
        ...
        country.getById('226', (data) => {
            ...
            expect(rawData.data).toEqual(expect.objectContaining({
                prefix: 'Choose a State/Province',
            }));

            expect(rawData.data.states).toEqual(expect.objectContaining([
                { id: '1', name: 'Alabama' },
                { id: '2', name: 'Alaska' },
            ]));
        });
